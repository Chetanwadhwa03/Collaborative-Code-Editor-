...
const Landingpage = () => {
  ...
  async function handlesignup(e) {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}api/v1/signup`, content)
      toast.dismiss()
  ...
  async function handlesignin(e) {
    ...
    const content = Object.fromEntries(formdata)
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}api/v1/signin`, content)
